...
public class ExceptionMiddleware
{
    ...
    private async Task HandleExceptionAsync(HttpContext context, ExceptionCode exceptionCode = ExceptionCode.Generic, string? addtionalInfo = null, HttpStatusCode httpStatusCode = HttpStatusCode.InternalServerError)
    {
